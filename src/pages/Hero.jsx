    ...
    return (
        <section className='bg-oq dark:bg-dakr py-[50px]'>
            <div className='container  flex lg:flex-row  flex-col items-center justify-between'>
                <img src="https://raw.githubusercontent.com/kinddevs2024/Tolibs/refs/heads/main/public/Education-cuate.svg" alt="" className='  flex lg:hidden lg:w-[50%] w-[100%]' />
                ...
                <img src="https://raw.githubusercontent.com/kinddevs2024/Tolibs/refs/heads/main/public/Education-cuate.svg" alt="" className=' hidden lg:flex lg:w-[50%] w-[100%]'/>
            </div>
        </section>
    )
}
